...
const OrderDetail = () => {
    ...
    const steps = [
        ...
        { status: ORDER_STATUS.DELIVERED, label: 'Livrée avec succès', time: order.deliveredAt },
    ];
                    ...
                    {(order.livreur || order.status === ORDER_STATUS.IN_DELIVERY) && (
                        <Card title="Votre livreur">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <div>
                                    <p className="font-bold text-gray-900">{order.livreur?.fullName || 'Jean Livreur'}</p>
                                    <p className="text-sm text-gray-500">⭐ 4.8 (85 livraisons)</p>
                                </div>
                            </div>
