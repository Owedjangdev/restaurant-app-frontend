...
import { Mail, Phone, MapPin, User, Edit2, Save, X, Truck } from 'lucide-react';
...
const LivreurProfile = () => {
  ...
  const handleSave = async () => {
    setLoading(true);
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/livreur/profile`, {
        method: 'PUT',
        headers: {
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-green-600 to-green-700 px-6 py-8 text-white">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-green-100">Livreur</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Vehicle */}
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Véhicule</label>
                <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                  ...
                  {isEditing ? (
                    ...
                    <span className="text-gray-900 font-medium">{formData.vehicle || 'Non renseigné'}</span>
                  )}
                </div>
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                  {isEditing ? (
                    ...
                    <span className="text-gray-900 font-medium">{formData.licenseNumber || 'Non renseigné'}</span>
                  )}
                </div>
              </div>
            </div>
