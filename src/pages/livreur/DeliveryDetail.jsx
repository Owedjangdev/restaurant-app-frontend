...
const DeliveryDetail = () => {
    ...
    const handleUpdateStatus = async (newStatus) => {
        ...
        try {
            ...
            await orderService.updateOrderStatus(id, newStatus, location);
        ...
        <div className="space-y-6 pb-24">
                ...
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                        <div className="w-12 h-12 bg-blue-100 rounded-2xl flex items-center justify-center text-blue-600">
                            <span className="font-black text-lg">{delivery.client?.fullName.charAt(0)}</span>
                        </div>
                        <div>
                            <h2 className="font-black text-gray-900">{delivery.client?.fullName}</h2>
            ...
            >
                <div className="text-center space-y-4">
                    ...
                    <p className="text-gray-600">Confirmez-vous que le colis a été remis en mains propres au client ?</p>
                    <div className="pt-4 space-y-2">
                        ...
                        <Button variant="ghost" fullWidth onClick={() => setIsConfirmModalOpen(false)}>Annuler</Button>
                    </div>
                </div>
            </Modal>
        </div>
